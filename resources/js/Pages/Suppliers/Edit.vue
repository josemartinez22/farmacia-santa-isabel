...
const updateSupplier = () => {
    form.post(route('supplier.update', props.supplier.id), {
        preserveScroll: true
    });
};
        ...
        <template #header>
            <div class="flex justify-start max-w-3xl">
                <h1 class="font-semibold text-xl text-gray-800 leading-tight">
                    <Link class="text-indigo-400 hover:text-indigo-600" :href="route('suppliers')">Proveedores</Link>
